...
**More fragile than D07** — a smaller diameter than an already-fragile bit. Constant chip clearance, dead-slow feeds, and a toolpath that never dwells or reverses under load.

**Unconfirmed shank and flute count.** Every other small Inventables bit in the shop (D07, B03) uses a 1/8" shank and 2 flutes, and this one is assumed to match.
