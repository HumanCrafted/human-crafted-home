...
The ridge pattern started as a 3D print. I modeled the concentric texture, printed it, and used that print to make a silicone mold. More specifically, the 3D printed pattern was made by the SLS (selective laser sintering) process, which is known for it's powdery texture, and perfect for the concentric coaster. From there it's the usual concrete process: mix, pour, vibrate the bubbles out, cure, demold, and sand by hand. A cork base goes on the bottom to keep it off the table surface. Each one comes out a little different.
